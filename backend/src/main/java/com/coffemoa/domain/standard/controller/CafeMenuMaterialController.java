...
import com.coffemoa.domain.standard.mapper.CafeMenuMaterialMapper;
...
@RequestMapping("/api/cafe-menu-materials")
public class CafeMenuMaterialController {

  private final CafeMenuMaterialMapper mapper;
  ...
  @GetMapping
  public ApiResponse<List<CafeMenuMaterial>> select(@RequestParam Map<String, String> param) {
