...
import com.coffemoa.domain.standard.mapper.CafeMenuPriceMapper;
...
public class CafeMenuPriceController {
  ...
  private final CafeMenuPriceMapper mapper;
  ...
  @GetMapping
  public ApiResponse<List<CafeMenuPrice>> select(@RequestParam Map<String, String> param) {
