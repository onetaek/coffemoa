...
<template>
  <ElDrawer v-model="modelValue" title="Column settings" size="350px">
    <div>
    ...
    <template #footer>
      <div>
        <BaseButton @click="restore">reduction</BaseButton>
        <BaseButton type="primary" @click="confirm">Sure</BaseButton>
      </div>
    </template>
  </ElDrawer>
</template>
